...
def _validate_evaluation(
    ...
    *,
    ...
    return storage, rate, conduction, displacement
...
def solve_frequency_domain(
    ...
    *,
    ...
    storage_0, rate_0, current_0, displacement_0 = _validate_evaluation(
        base,
        state_size=coordinate.size,
    )
    del rate_0, current_0, displacement_0
    state_size = coordinate.size
    ...
    for index, frequency in enumerate(omega_hz):
        ...
        admittance_faces[index] = conduction + 1j * angular_frequency * displacement
