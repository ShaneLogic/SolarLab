    ...
    <div class="doc-body">
      ...
      <table class="param-table">
        ...
        <tbody>
          ...
          <tr><td><code>optical_material</code></td><td>TMM n,k key</td><td>—</td><td>String key that selects a complex-index CSV from <code>perovskite_sim/data/nk/</code>. When any layer sets this field and Mode = <b>Full</b>, the solver replaces Beer–Lambert with the Pettersson/Burkhard transfer-matrix method and AM1.5G. <code>n_optical</code> provides a constant-<i>n</i> fallback.</td></tr>
        </tbody>
      </table>
