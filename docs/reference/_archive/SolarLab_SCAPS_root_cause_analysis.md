...
### 1.2 The reference Base Model stack
...
- **Reference SCAPS report and parameter table:** `docs/superpowers/references/scaps_1d_simulation_report.pdf`, `docs/superpowers/references/scaps_1r_parameters.xlsx`.
...
- **Prior analysis (tested, not assumed):** `docs/reference/SolarLab_SCAPS_gap_analysis.md`.
...
2. **PCE/FF FOM splice** (reporting layer, not solver): cross-run cell-mixing in reference-facing tables (§5.3). **The only cheap-to-fix correctness issue.**
...
2. M. Burgelman, J. Marlein. "Analysis of graded band gap solar cells with SCAPS." *Thin Solid Films* **515**(15), 6276–6278 (2007). — Intra-band tunnelling at heterointerfaces (OFF in the reference model).
